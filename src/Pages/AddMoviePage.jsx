        ...
        <form onSubmit={handleSubmit} className="card shadow-2xl bg-base-100 p-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="form-control">
              ...
              <input type="text" name="title" placeholder="Movie Title" className="input input-bordered w-full" required />
            </div>

            {/* Genre */}
            <div className="form-control">
              <label className="label"><span className="label-text">Genre</span></label>
              <input type="text" name="genre" placeholder="e.g., Sci-Fi, Drama" className="input input-bordered w-full" required />
            </div>

            {/* Release Year */}
            <div className="form-control">
              <label className="label"><span className="label-text">Release Year</span></label>
              <input type="number" name="releaseYear" placeholder="e.g., 2010" className="input input-bordered w-full" required />
            </div>

            {/* Rating */}
            <div className="form-control">
              <label className="label"><span className="label-text">Rating (out of 10)</span></label>
              <input type="number" name="rating" placeholder="e.g., 8.8" step="0.1" min="0" max="10" className="input input-bordered w-full" required />
            </div>

            {/* Director */}
            <div className="form-control">
              <label className="label"><span className="label-text">Director</span></label>
              <input type="text" name="director" placeholder="e.g., Christopher Nolan" className="input input-bordered w-full" required />
            </div>

            {/* Duration */}
            <div className="form-control">
              <label className="label"><span className="label-text">Duration (in minutes)</span></label>
              <input type="number" name="duration" placeholder="e.g., 148" className="input input-bordered w-full" required />
            </div>

            {/* Cast */}
            <div className="form-control md:col-span-2">
              <label className="label"><span className="label-text">Cast</span></label>
              <input type="text" name="cast" placeholder="e.g., Leonardo DiCaprio, Joseph Gordon-Levitt" className="input input-bordered w-full" required />
            </div>

            {/* Poster URL */}
            <div className="form-control md:col-span-2">
              <label className="label"><span className="label-text">Poster URL</span></label>
              <input type="url" name="posterUrl" placeholder="https://i.ibb.co/example.jpg" className="input input-bordered w-full" required />
            </div>

            {/* --- NEW: Trailer URL --- */}
            <div className="form-control md:col-span-2">
              <label className="label"><span className="label-text">Trailer Embed URL (YouTube)</span></label>
              <input type="url" name="trailerUrl" placeholder="https://www.youtube.com/embed/..." className="input input-bordered w-full" />
            </div>

            {/* Language */}
            <div className="form-control">
              <label className="label"><span className="label-text">Language</span></label>
              <input type="text" name="language" placeholder="e.g., English" className="input input-bordered w-full" required />
            </div>

            {/* Country */}
            <div className="form-control">
              <label className="label"><span className="label-text">Country</span></label>
              <input type="text" name="country" placeholder="e.g., USA" className="input input-bordered w-full" required />
            </div>

            {/* --- NEW: Awards --- */}
            <div className="form-control md:col-span-2">
              <label className="label"><span className="label-text">Awards</span></label>
              <input type="text" name="awards" placeholder="e.g., Won 3 Oscars" className="input input-bordered w-full" />
            </div>
            ...
            <div className="form-control md:col-span-2 flex flex-col justify-between">
              ...
              <textarea name="plotSummary" className="textarea textarea-bordered h-24 w-full" placeholder="A brief summary of the movie..." required></textarea>
            </div>

            {/* --- NEW: Trivia --- */}
            <div className="form-control md:col-span-2 flex flex-col justify-between">
              <label className="label"><span className="label-text">Trivia (Put each fact on a new line)</span></label>
              <textarea name="trivia" className="textarea textarea-bordered h-32 w-full" placeholder="Fact 1&#10;Fact 2&#10;Fact 3"></textarea>
            </div>
