        ...
        <div className="container mx-auto px-4 lg:max-w-6xl">
          ...
          <div className="card lg:card-side bg-base-100 shadow-xl overflow-hidden mb-10">
            ...
            <div className="card-body lg:w-2/3">
              ...
              <p className="text-lg text-base-content/80 italic mb-6">
                "{movie.plotSummary}"
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm mb-6">
                <div>
                  <span className="font-bold block text-base-content/60">
                    Director
                  </span>{" "}
                  {movie.director}
                </div>
              ...
              <div className="card-actions justify-end items-center gap-4">
                {user ? (
                  ...
                  <button onClick={()=> navigate("/login")} className="btn btn-disable ">
